...
public abstract class TernaryMathsQuestionFactoryTest {
    @MockBean
    ...
    public TernaryMathsQuestionFactoryTest(QuestionType questionType, int points) {
    ...
    void generateRandomQuestion(String id, int n1, int n2, int n3, String expectedText, String expectedAnswer) {
        when(randomizer.nextQuestionId()).thenReturn(id);
        when(randomizer.nextInt(20)).thenReturn(n1, n2, n3);
